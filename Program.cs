...
using (var scope = app.Services.CreateScope())
{
    ...
    db.Database.ExecuteSqlRaw(@"
        ...
        CREATE TABLE IF NOT EXISTS ""InitiativeChangeRequests"" (
            ...
            -- NOTE: no DEFAULT of empty-braces on the two JSON columns. This SQL
            -- passes through .NET string formatting, so literal braces crash
            -- startup with a FormatException. EF always supplies these values.
